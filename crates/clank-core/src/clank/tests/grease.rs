...
fn grease_install_an_mcp_server_registers_tools_prompts_resources() {
    on_rt(async {
        ...
        assert!(session
            ...
            .unwrap()
            .is_mcp_tool_line("demo echo --text hi"));
        assert!(session
            .plugin_ref::<crate::clank::Clank>()
            .unwrap()
            .grease
...
fn grease_install_a_skill_materializes_and_surfaces_it() {
    on_rt(async {
        ...
        assert!(session
            ...
            .unwrap()
            .grease
            .is_skill("code-review"));
        assert!(!session
            .plugin_ref::<crate::clank::Clank>()
            .unwrap()
            .grease
            .is_script("code-review"));
        assert!(!session
            .plugin_ref::<crate::clank::Clank>()
            .unwrap()
            .grease
            .is_prompt("code-review"));
        assert!(session
            .plugin_ref::<crate::clank::Clank>()
            .unwrap()
            .grease
            .manifest_for("code-review")
            .is_none());
        assert!(crate::ai::ask::grease_ask_tool_definitions(
